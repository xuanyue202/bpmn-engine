...
module.exports = internals.Flow = function(activity, parentContext, options) {
...
function asyncEmitEvent(eventName, variables, rootFlow, options) {
  //setImmediate(() => {
    let that = this;
    this.options.promise = this.options.promise.then(()=>{
      return new Promise((resolve, reject) => {
         that.emit(eventName, that, rootFlow);
         resolve();
      });
    })
